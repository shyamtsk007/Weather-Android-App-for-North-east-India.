...
public class NowJorActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_now_jor);
        String pilihan = "l";
        if (pilihan.equals("l")) {
            WebView webview = (WebView) findViewById(R.id.nowjor);
            ...
            String pdf = "http://www.imdguwahati.gov.in/nowdjorhat.pdf";
