...
public class NowLakhActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_now_lakh);
        String pilihan = "l";
        if (pilihan.equals("l")) {
            WebView webview = (WebView) findViewById(R.id.nowlakh);
            ...
            String pdf = "http://www.imdguwahati.gov.in/nowlakhimpur.pdf";
