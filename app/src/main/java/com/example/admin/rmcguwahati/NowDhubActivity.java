...
public class NowDhubActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_now_dhub);
        String pilihan = "l";
        if (pilihan.equals("l")) {
            WebView webview = (WebView) findViewById(R.id.nowdhub);
            ...
            String pdf = "http://www.imdguwahati.gov.in/nowdhubri.pdf";
